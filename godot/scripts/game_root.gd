...
func _draw_background() -> void:
    draw_rect(Rect2(Vector2.ZERO, GameConstants.CANVAS_SIZE), GameConstants.COLOR_BG, true)
    draw_rect(Rect2(Vector2(3.0, 3.0), GameConstants.CANVAS_SIZE - Vector2(6.0, 6.0)), Color(0.0, 1.0, 1.0, 0.15), false, 4.0)
    draw_rect(Rect2(Vector2(1.0, 1.0), GameConstants.CANVAS_SIZE - Vector2(2.0, 2.0)), Color(0.0, 1.0, 1.0, 0.4), false, 2.0)
